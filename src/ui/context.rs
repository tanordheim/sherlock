use gio::{glib::object::{Cast, CastNone, ObjectExt}, prelude::ListModelExt, ListStore};
use gtk4::{prelude::{ListItemExt, WidgetExt}, ListView, SignalListItemFactory, SingleSelection};
