...
| `global_prefix` | `None`   | Prepends this to every application's execution command. ||
| `global_flags` | `None`   | Appends these flags to every application's execution command. ||
